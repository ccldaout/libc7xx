 ...
 */
#ifndef C7_NSEQ_REVERSE_HPP_LOADED_
#define C7_NSEQ_REVERSE_HPP_LOADED_
...
#define C7_NSEQ_ITER_TYPE_	reverse_iter
#define C7_NSEQ_ITEREND_TYPE_	reverse_iter_end
